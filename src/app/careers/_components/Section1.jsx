const Section1 = () => {
  return (
    <>
      <section className="bg-white py-24 lg:pb-0 bg-menuPage-layer-image bg-no-repeat bg-right bg-contain">
        <div className="container mx-auto">
          <h2 className="custom-h2 px-6">The Best Team on <br /> The Planet Always</h2>
